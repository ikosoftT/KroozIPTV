...
const social = await fs.readFile('public/images/devices.svg', 'utf8');
await sharp(Buffer.from(social.replace('Meet your next screen.', 'Entertainment, your way.')))
  .jpeg({ quality: 90 })
  .toFile('public/images/social.jpg');
await sharp('app/icon.svg').resize(180, 180).png().toFile('public/apple-icon.png');
